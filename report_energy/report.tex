...
If LEV shedding, the strength  of the $LEV$ shed at the current time step is determined such that  the instantaneous LESP value is made equal to the LESPc: $A_0(t)=LESPc$, if $A_0(t)<LESPc$ no LEV sheding is performed.
...
\begin{equation}
G(t) = \ln \left[ 
    \cosh\left( \frac{a U_\infty (t - t_1)}{c} \right)
